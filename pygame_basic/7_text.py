...
# 20 fps : 20 * 5 = 100
    ...
    # insert timer
    # time which goes check
    elapsed_time = (pygame.time.get_ticks() - start_ticks) / \
        1000  # to present second unit

    timer = game_font.render(
        str(int(total_time - elapsed_time)), True, (255, 255, 255)) # (text, True, font color)
    
    screen.blit(timer, (10,10))

    # If remaining time is equal to 0, the game exit. 
