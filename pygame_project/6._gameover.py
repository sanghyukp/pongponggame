# 1. all of balls are removed.
# 2. collide between character and balls
# 3. time over
...
total_time = 100
start_ticks = pygame.time.get_ticks() # set strat time

# text message for exit
# Time out, mission complete, 
    ...
    for ball_idx, ball_val in enumerate(balls):
        ...
        for weapon_idx, weapon_val in enumerate(weapons):
            ...
            if weapon_rect.colliderect(ball_rect):
                ...
                # not if the ball is smallest, divide balls into two
                if ball_img_idx < 3:
                    ...
                    # bounding to the left
                    balls.append({
                        "pos_x": ball_pos_x + (ball_width / 2) - (small_ball_width / 2),  # ball's x
                        "pos_y": ball_pos_y + (ball_height / 2) - (small_ball_height / 2),  # ball's y
            ...
            continue # if inner for does not meet, external for continue
        break # if inner for face break, external for also face break
